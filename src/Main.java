...
public class Main {
    public static void main(String[] args) {
        File backupFile = new File("src/resources/backup.txt");
        ...
        try {
            taskManager.save();
            System.out.println("Manager saved successfully to the backup file.");
        } catch (ManagerSaveException e) {
            System.out.println("Failed to save the manager to the backup file: " + e.getMessage());
        }
    }
